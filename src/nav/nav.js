...
<div>
    <div className="common-nav">
        ...
        <NavLink to='/app' activeClassName='active'><img src={unship} alt="" /><p>待发货</p></NavLink>
        <NavLink to='/app' activeClassName='active'><img src={undelivery} alt="" /><p>待收货</p></NavLink>
        <NavLink to='/app' activeClassName='active'><img src={unevaluation} alt="" /><p>待评价</p></NavLink>
